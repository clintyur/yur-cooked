...
const RECIPES = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Buttermilk",           amount: "enough to fully cover",      img: "images/ingredients/milk.png" },
      { name: "Pickle juice",         amount: "3 tbsp",                     img: "images/ingredients/salt.png" },
      { name: "Kosher salt",          amount: "to season",                  img: "images/ingredients/salt.png" },
      { name: "Black pepper",         amount: "to season",                  img: "images/ingredients/black-pepper.png" },
      { name: "Garlic powder",        amount: "to season",                  img: "images/ingredients/garlic.png" },
      { name: "Onion powder",         amount: "to season",                  img: "images/ingredients/garlic.png" },
      { name: "Smoked paprika",       amount: "to season",                  img: "images/ingredients/salt.png" },
      { section: "The Dredge" },
      { name: "All-purpose flour",    amount: "a generous amount",          img: "images/ingredients/flour.png" },
      { name: "Kosher salt",          amount: "to season the flour",        img: "images/ingredients/salt.png" },
      { name: "Black pepper",         amount: "to season the flour",        img: "images/ingredients/black-pepper.png" },
      { name: "Onion powder",         amount: "to season the flour",        img: "images/ingredients/garlic.png" },
      { name: "Garlic powder",        amount: "to season the flour",        img: "images/ingredients/garlic.png" },
      { name: "Smoked paprika",       amount: "to season the flour",        img: "images/ingredients/salt.png" },
      { section: "To Fry" },
      { name: "Duck fat",             amount: "enough to fill pot halfway",  img: "images/ingredients/duck-fat.png" },
    ],
    steps: [
      { section: "The Marinade" },
